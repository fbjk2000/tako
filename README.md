...
<p align="center">
  ...
  <a href="#recent-updates-apr-2026">Recent Updates</a>
</p>
...
- **Tasks** — Pulse view (Tasks v2 / phase 1, May 2026): outcome-first cards bucketed into Suggested by TAKO · Overdue · Today · This Week, ranked by deal urgency, contact decay and external signals (not by raw due date). Multi-entity link chips (deal · company · contact · campaign · project) on every card; click a chip to jump to that entity. The "Suggested by TAKO" section is wired to receive Sentinel suggestions in phase 2. Inbound query-string filters from elsewhere in the app pre-scope the view (`?deal=…`, `?contact=…`, etc.). Old kanban + list views, subtasks/checklists, and comments are retired with the Pulse rewrite — they re-land in a future phase if usage signals call for them.
